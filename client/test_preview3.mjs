...
async function main() {
  console.log('Launching browser with custom browser path...');
  const browser = await chromium.launch({ 
    headless: true,
    executablePath: '/home/lmz/.cache/ms-playwright/chromium_headless_shell-1228/chrome-linux/headless_shell',
